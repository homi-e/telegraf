                ...
                for package_type in supported_packages[platform]:
                    ...
                    if package_type in ['zip', 'tar']:
                        ...
                        if package_type == "rpm":
                            ...
                            fpm_command += " --config /etc/telegraf/telegraf.conf"
                        if package_type == "deb":
                            conf = os.path.join(build_root, '/etc/telegraf/telegraf.conf')
                            shutil.copy(conf, conf + '.sample')
                            fpm_command += " --config /etc/telegraf/telegraf.conf.sample"
